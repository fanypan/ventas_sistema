			...
			<tbody id="detalle_productos">
				...
				if ($result_compra > 0) {
					...
					?>
							...
							<td><?php echo $moned.' '.formatCant($totalventa); ?></td>
							</tr>
							<tr id="">
							<td width="50%"><?php echo 'Coste de bienes vendidos'; ?></td>
							<td><?php echo $moned.' '.formatCant($compras,2); ?></td>
							</tr>
							...
							<tfoot id="detalle_totales">
								<tr>
									...
									<td class=""><span><?php echo $moned.' '.formatCant($beneficio_bruto);?></span></td>
								</tr>								
							</tfoot>			
	</table>
	<table id="factura_detalle">
				...
				if ($result_gasto > 0) {
					while ( $data_gasto = mysqli_fetch_assoc($query_gasto)) {
						...
						<tr id="">
							...
							<td><?php echo $moned.' '.formatCant($gastos); ?></td>
						</tr>
					<?php }					
					}
					...
					?>
							...
							<tfoot id="detalle_totales">
								<tr>
									...
									<td class=""><span><?php echo $moned.' '.formatCant($gastos_operativo);?></span></td>
								</tr>
								<tr>
									<td colspan="" class=""><span>Beneficios Operativos</span></td>
									<td class=""><span><?php echo $moned.' '.formatCant($beneficios_operativo);?></span></td>
								</tr>
