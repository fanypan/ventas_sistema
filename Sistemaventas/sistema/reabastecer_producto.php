	...
	<section id="container">
		<?php if ($result_caja > 0) { ?>
			<div style="flex-wrap: wrap;">
				<div>
				<h1 class="titlePanelControl">Reabastecer Stock</h1>
			</div>
				...
				<tr>
					<td><input type="hidden" name="idproveedor" id="idproveedor">
						<div style="display: flex; align-items: center;">
							<input type="text" name="nom_proveedor" id="nom_proveedor" placeholder="Nombre del proveedor" style="flex: 1;">
							<a href="#" class="btn_new" id="buscar_proveedor_modal" onclick="event.preventDefault(); abrirModalBusquedaProveedor();" style="margin-left: 5px; padding: 5px 10px;" title="Buscar Proveedor"><i class="fas fa-search"></i></a>
							<a href="#" class="btn_new" id="nuevo_proveedor_modal" onclick="event.preventDefault(); abrirModalNuevoProveedor();" style="margin-left: 5px; padding: 5px 10px; background: #286581;" title="Nuevo Proveedor"><i class="fas fa-plus"></i></a>
						</div>
						<input type="number" name="tel_proveedor" id="tel_proveedor" disabled placeholder="Teléfono" min="0">
...
$(document).on('submit', '#form_del_product', function(e) {
