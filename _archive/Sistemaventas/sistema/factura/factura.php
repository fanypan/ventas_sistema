...
<div id="page_pdf">
	...
	<table id="factura_detalle">
			...
			<?php
				...
				$tl_sniva1 = formatCant($subtotal - $impuesto);
				$impuesto1 = formatCant($subtotal * ($iva / 100));
			...
			<tfoot id="detalle_totales">
				<tr>
					...
					<td class=""><span> <?php echo $moned.' '.formatCant($total); ?></span></td>
				</tr>
				<tr>
					<td colspan="3" class="textright"><span>Descuento &nbsp;&nbsp;&nbsp; </span></td>
					<td class=""><span> <?php echo $moned.' '.formatCant($desc); ?></span></td>
				</tr>
				<tr>
					<td colspan="3" class="textright"><span>TOTAL &nbsp;&nbsp;&nbsp; </span></td>
					<td class=""><span> <?php echo $moned.' '.formatCant($total-$desc); ?></span></td>
				</tr>
			</tfoot>
	</table>
	<div>
