	...
	<section id="container">
		...
		<div>
			...
			<form action="" method="post" class="form_search_date" id="rango">
				...
				<a href="#" class="btn_view" id="reporte_pdf_compra" title="Generar PDF">PDF</a>
				<a href="#" class="btn_view" id="descargar_excel_compras" style="background-color: #2ecc71; margin-left: 5px; border-color: #2ecc71;" title="Exportar a Excel"><i class="fas fa-file-excel"></i></a>
			</form>
