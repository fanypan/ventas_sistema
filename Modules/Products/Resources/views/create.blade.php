                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('warranty_months') is-invalid @enderror" id="warranty_months" name="warranty_months" placeholder="12" value="{{ old('warranty_months', 12) }}" min="0">
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body text-center">
                            <div id="image-preview-container" class="mb-3 border rounded p-2 bg-light" style="min-height: 200px; display: flex; align-items: center; justify-content: center;">
                                <img id="image-preview" src="{{ asset('images/no-image.png') }}" class="img-fluid rounded" style="max-height: 200px; object-fit: contain;" alt="Vista previa">
                            </div>
                            <div class="form-group">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input @error('image') is-invalid @enderror" id="image" name="image" accept="image/*">
                                    <label class="custom-file-label" for="image">Elegir foto</label>
                                </div>
                                @error('image')
